...
class Migration(migrations.Migration):
    dependencies = [
        ('bookings', '0006_fix_booking_member_reference'),
    ]

    operations = [
        migrations.RunSQL(
            sql='ALTER TABLE bookings_bookingmember DROP CONSTRAINT bookings_bookingmember_pkey CASCADE;',
        ...
        migrations.RunSQL(
            sql='ALTER TABLE bookings_bookingmember DROP CONSTRAINT bookings_bookingmember_booking_id_fkey;',
